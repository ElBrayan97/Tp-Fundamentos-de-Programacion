...
Begin
 ...
 Textcolor(blue);
 Gotoxy (34,4); Writeln ('////////////////////////////////////////////////////////////////');
 Gotoxy (34,5); Writeln ('//Ingrese el DNI del Artista para ver sus obras:              //');
 Gotoxy (34,6); Writeln ('////////////////////////////////////////////////////////////////');
 textcolor(green);
 Gotoxy (83,5); Readln(busc);
End;
...
Begin
 ...
 Writeln ('|                                \\');
 Writeln ('|     '); Gotoxy(6,3); TextColor(Green); Writeln('MENU DE CARGA DE OBRA'); TextColor(Blue); Gotoxy(28,3); Writeln ('      \\');
...
Begin
 ...
 Writeln ('|                                 \\');
 Writeln ('|     '); Gotoxy(6,3); TextColor(Green); Writeln('MENU DE CARGA DE ARTISTAS'); TextColor(Blue); Gotoxy(32,3); Writeln ('   \\');
...
Begin
 ...
 Writeln (' ________________________________');
 Writeln ('|                                \\');
 Writeln ('|    '); TextColor(Green); Gotoxy(5,3); Writeln('MENU DE CARGA DE MUSEO'); TextColor(Blue); Gotoxy(28,3); Writeln ('      \\');
...
Begin
 ...
 Gotoxy (30,5); Writeln ('/////////////////////////////////////////////////////////');
 TextColor(Green);
 Gotoxy (34,2); Writeln ('Ingrese el Nombre de la obra que desea modificar');
 TextColor(Green);
 Gotoxy (33,4);
 Readln(Bus);
End;
...
Begin
 TextColor(Blue);
 Writeln ('|\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\');
 Writeln ('|                        ');TextColor (Green); Gotoxy(25,2); Writeln('DATOS ENCONTRADOS'); TextColor (Blue); Gotoxy(42,2); Writeln('                         \\');
 Writeln ('|------------------------------------------------------------------\\');
 Writeln ('| Artista:                                                         \\'); 
 Writeln ('|------------------------------------------------------------------\\');
...
Begin
 ...
 Gotoxy (30,5); Writeln ('/////////////////////////////////////////////////////////');
 TextColor(Green);
 Gotoxy (35,2); Writeln('Ingrese el Nombre del artista que desea modificar');
 Gotoxy (33,4); 
 Readln(Bus);
End;
...
Begin
 ...
 TextColor(Green);
 Gotoxy (77,1 ); Writeln ('////////////////////////////////');
 Gotoxy (77,2 ); Writeln ('// ELIJA EL CAMPO A MODIFICAR //');
 Gotoxy (77,3 ); Writeln ('////////////////////////////////');
 Gotoxy (77,4 ); Writeln ('//--> 1- D.N.I.               //');
 Gotoxy (77,5 ); Writeln ('//--> 2- Nombre               //');
 Gotoxy (77,6 ); Writeln ('//--> 3- Direccion            //');
 Gotoxy (77,7 ); Writeln ('//--> 4- Fecha de nacimiento  //');
 Gotoxy (77,8 ); Writeln ('//----------------------------//');
 Gotoxy (77,9 ); Writeln ('//--> 0- Salir                //');
 Gotoxy (77,10); Writeln ('//----------------------------//');
 Gotoxy (1,13); Writeln ('\\------------------------------------------------------------------------\\');
 Gotoxy (1,14); Writeln ('\\                                                                        \\');
 Gotoxy (1,15); Writeln ('\\------------------------------------------------------------------------\\');
End;
...
Begin
 ...
 Gotoxy (30,5); Writeln ('/////////////////////////////////////////////////////////');
 TextColor(Green);
 Gotoxy (35,2); Writeln('Ingrese el Nombre del Museo que desea modificar');
 Gotoxy (33,4); 
 Readln(Bus);
End;
...
Begin
 ...
 TextColor (Green);
 Gotoxy (77,7 ); Writeln ('//////////////////////////////////////'); 
 Gotoxy (77,8 ); Writeln ('//ELIJA EL CAMPO QUE DESEA MODIFICAR//');
 Gotoxy (77,9); Writeln ('//////////////////////////////////////'); 
 Gotoxy (77,10); Writeln ('//--> 1- D.N.I. del Director        //');
 Gotoxy (77,11); Writeln ('//--> 2- Nombre                     //');
 Gotoxy (77,12); Writeln ('//--> 3- Telefono                   //');
 Gotoxy (77,13); Writeln ('//--> 4- Calle                      //');
 Gotoxy (77,14); Writeln ('//--> 5- Pais                       //');
 Gotoxy (77,15); Writeln ('//--> 6- Ciudad                     //');
 Gotoxy (77,16); Writeln ('//////////////////////////////////////');
 Gotoxy (77,17); Writeln ('//--> 0- Salir                      //');
 Gotoxy (77,18); Writeln ('//////////////////////////////////////');
End;
...
Begin
 ...
 Gotoxy (30,5); Writeln ('//////////////////////////////////////////////////////////');
 TextColor(Green);
 Gotoxy (34,2); Writeln ('Ingrese el Nombre del Director que desea modificar');
 Gotoxy (33,4);
 Readln(Bus);
End;
...
Begin
 ...
 TextColor(Blue);
 Writeln ('|\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\');
 Writeln ('|                  ');TextColor (Green); Gotoxy(19,2); Writeln ('DATOS ENCONTRADOS'); TextColor (Blue); Gotoxy(36,2); Writeln('                         \\');
 Writeln ('|------------------------------------------------------------\\');
 Writeln ('| Nombre:                                                    \\'); 
 Writeln ('|------------------------------------------------------------\\');
 Writeln ('| D.N.I.:                                                    \\');
 ...
 Gotoxy (1,18);
 Gotoxy (64,1); Writeln ('|\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\');
 Gotoxy (64,2); Writeln ('| ');TextColor (Green); Gotoxy(66,2); Writeln ('ELIJA EL CAMPO QUE DESEA MODIFICAR'); TextColor(Blue);  Gotoxy(100,2); Writeln('      \\');
 Gotoxy (64,3); Writeln ('|-----------------------------------------\\');
 Gotoxy (64,4); Writeln ('|   '); TextColor (Green); Gotoxy(68,4); Writeln ('--> 1- Periodo Asignacion'); TextColor(Blue); Gotoxy(93,4); Writeln('             \\');
 Gotoxy (64,5); Writeln ('|   '); TextColor (Green); Gotoxy(68,5); Writeln ('--> 2- Nombre'); TextColor(Blue); Gotoxy(81,5); Writeln('                         \\');
 Gotoxy (64,6); Writeln ('|   '); TextColor (Green); Gotoxy(68,6); Writeln ('--> 3- Direccion'); TextColor(Blue); Gotoxy(84,6); Writeln('                      \\');
 Gotoxy (64,7); Writeln ('|   '); TextColor (Green); Gotoxy(68,7); Writeln ('--> 4- Telefono'); TextColor(Blue); Gotoxy(83,7); Writeln('                       \\');
 Gotoxy (64,8); Writeln ('|-----------------------------------------\\');
 Gotoxy (64,9); Writeln ('|   '); TextColor (Green); Gotoxy(68,9); Writeln('--> 0- Salir <--'); TextColor(Blue); Gotoxy(84,9); Writeln('                      \\');
...
Begin
 TextColor(Blue);
 Gotoxy (64,11); Writeln('|'); TextColor (Green); Gotoxy (65,11); Writeln('--> 1- Inicio del Periodo de Asignacion'); TextColor (Blue); Gotoxy (104,11); Writeln('  \\');
 Gotoxy (64,12); Writeln('|'); TextColor (Green); Gotoxy (65,12); Writeln('--> 2- Fin del Periodo de Asignacion'); TextColor (Blue); Gotoxy (101,12); Writeln('     \\');
 Gotoxy (64,13); Writeln('|                                         \\');
End;
